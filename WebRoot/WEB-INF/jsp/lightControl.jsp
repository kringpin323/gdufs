...
function setResult(o){
 ...
 if(null!=(document.getElementById("light"+(o[i][0])))){
     if(o[i][1]=="off"){ document.getElementById("light"+(o[i][0])).innerText = "关闭";} else{document.getElementById("light"+(o[i][0])).innerText = "打开";}
     }
    }
}
...
<tr><td colspan="5"><DIV class="nav">
  ...
  <s:iterator value="labInfos" var="lab_Info">
    <LI><A  href="javascript:lightList('${lab_Info.labId}','灯光')" >${lab_Info.labDesc}</A></LI>
   </s:iterator>  
  </UL>
</DIV></td></tr>
