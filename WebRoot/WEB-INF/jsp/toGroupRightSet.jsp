...
$.post('systemManger_chaxunStas2',{'groupId':userId},function(data){
	for(var i=0;i<30 ;i++){
...
<body>
<form id="form1" name="form1" method="post" action="systemManger_RightSet2?groupId=${groupId}">
  <table width="95%" border="1" cellspacing="0" cellpadding="0">
    <tr>
      <td height="20" colspan="3" align="center">用户组编号：
    <input type="text" id="userId" value="${groupId}" disabled="disabled"/>
