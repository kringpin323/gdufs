...
<body>
<p>实验室使用记录</p>
<table width="88%" height="70%" border="1" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center" >
    <div >
	     <table width="90%" border="0" cellspacing="0" cellpadding="0" height="75%">
	 
  <tr>
    <td>实验室：   
        <select name="labName">
      <option value="1">全部</option>
      <s:iterator value="labInfos" var="labInfo">
       <option value="${labInfo.labId }">${labInfo.labDesc }</option>
      </s:iterator>
    </select></td>
  </tr>
  <tr>
    <td>时间段：<input name="birthday" type="text" id="birthday2" title="点击选择" onClick="javascript:ShowCalendar(this.id)" size="20">
  到   <input name="birthday" type="text" id="birthday1" title="点击选择" onClick="javascript:ShowCalendar(this.id)" size="20">
</td>
  </tr>
  ...
  <tr >
    <td>
    		...
    		<table border="1" cellpadding="0" cellspacing="0" width="100%">
    			<tr>
    				<th>日期</th><th>时间</th><th>实验室</th><th>智能卡号</th><th>网页帐号</th><th>课程</th><th>摘要</th>
    			</tr>
    			<tr>
    				<td>日期</td><td>日期</td><td>日期</td><td>日期</td><td>日期</td><td>日期</td><td>日期</td>
    			</tr>
    		</table>
  ...
  <tr>
    <td>总共记录，当前是1/20页   首页  前一页  后一页  尾页</td>
  </tr>
  <tr>
    <td><input type="button" value="下载记录表"/></td>
  </tr>
</table>
</div>
</td>
